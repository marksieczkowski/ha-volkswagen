...
This integration was built using the [ha-volkswagen](https://github.com/git@github.com:marksieczkowski/ha-volkswagen.git/ha-volkswagen). If you're creating your own integration from this template, please update this file with your specific contribution guidelines.
